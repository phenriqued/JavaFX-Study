module p_henriqued.javafxstudy {
    ...
    opens p_henriqued.javafxstudy.Controller.SellerController to javafx.fxml;
    opens p_henriqued.javafxstudy.models.Sellers to javafx.base, javafx.fxml, org.hibernate.orm.core;
    ...
    exports p_henriqued.javafxstudy.Controller.SellerController;
